...
export default function MCRM(){
  ...
  const portal=()=>{
    const [portalC,setPortalC]=useState(clients[0]?.id||null);
    const c=clients.find(x=>x.id===portalC)||clients[0];
    ...
    return<div className="fi">
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:16}}>
        ...
        <div style={{display:"flex",gap:9,alignItems:"center"}}>
          <select value={portalC} onChange={e=>setPortalC(e.target.value)} style={{border:`1px solid ${bo}`,borderRadius:5,padding:"6px 11px",fontSize:13,fontFamily:U,color:es,outline:"none",background:cr}}>
