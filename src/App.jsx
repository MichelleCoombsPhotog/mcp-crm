...
Make it feel personal, reference their specific details naturally. Keep it warm, brief, and on-brand for Michelle.`;
 ...
 return<div className="fi">
 <H2 action={<Btn v="m" ch="+ New Contract" onClick={()=>{const nc={id:Date.now().toString(),name:"New Contract Template",type:"custom",active:true,body:"CONTRACT TEMPLATE\nThe Collective | Michelle Coombs Photography\n\n1. SERVICES\n[Describe services here]\n\n2. PAYMENT TERMS\n[Describe payment terms]\n\n3. CANCELLATION\n[Describe cancellation policy]\n\n4. GOVERNING LAW: State of Florida.\n\nPhotographer Signature: _________________________ Date: __________\nClient Signature: _________________________ Date: __________"};setContractTemplates(cs=>[...cs,nc]);setSelContract(nc);setEditContractMode(true);}}>Contracts</H2>
