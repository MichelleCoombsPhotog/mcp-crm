...
Make it feel personal, reference their specific details naturally. Keep it warm, brief, and on-brand for Michelle.`;
 ...
 <Card sx={{padding:26,marginBottom:18}}>
 <div style={{fontSize:14,letterSpacing:"0.12em",textTransform:"uppercase",color:br,fontFamily:D,marginBottom:14}}>Square Payment Link</div>
 <div style={{fontSize:14,color:br,fontFamily:D,lineHeight:1.8,marginBottom:12}}>Paste your Square payment link here. When you click "Pay via Square" on any invoice, this link will open so your client can pay online. Find it in: Square Dashboard → Online Checkout → Payment Links → Create a link.</div>
 <div style={{display:"flex",gap:10,alignItems:"flex-end"}}>
 <div style={{flex:1}}><Inp label="Square Checkout URL" value={sqLink} onChange={e=>setSqLink(e.target.value)} ph="https://square.link/u/xxxxxxxx"/></div>
 <Btn v="m" ch="Save" sx={{marginBottom:14}} onClick={()=>{if(sqLink){toast("Square link saved! It will appear on all unpaid invoices.");}else{toast("Please paste your Square link first.");}}}/>
 </div>
 <div style={{fontSize:13,color:tl,fontFamily:D}}>Your link is saved per-session only. For permanent saving, contact your developer to add it to Supabase settings.</div>
 </Card>
